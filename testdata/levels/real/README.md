...
验收：`playerStart ≈ (127,391)`、`goalRegion ≈ (528,41,52×72)`、平台 15 条、墙 7 条、块 2 个。
2026-09-21 墙门限 56→30 后更新：左上角凹形 4 根短竖笔（35~68px）全部识别为墙
（此前 3 根死在 56px 最短长度门限，用户报"凹型不符合预期"）。
